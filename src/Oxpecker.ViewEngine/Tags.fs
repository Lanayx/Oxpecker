...
module Tags =
    ...
    type form() =
        ...
        member this.action with set value = this.attr("action", value) |> ignore
        member this.method with set value = this.attr("method", value) |> ignore
        member this.enctype with set value = this.attr("enctype", value) |> ignore
        member this.target with set value = this.attr("target", value) |> ignore
    ...
    type script() =
        ...
        member this.async with set value = this.attr("async", value) |> ignore
    ...
    type input() =
        ...
        member this.placeholder with set value = this.attr("placeholder", value) |> ignore
        member this.required with set value = this.attr("required", value) |> ignore
        member this.autofocus with set value = this.attr("autofocus", value) |> ignore
        member this.autocomplete with set value = this.attr("autocomplete", value) |> ignore
        member this.min with set value = this.attr("min", value) |> ignore
        member this.max with set value = this.attr("max", value) |> ignore
        member this.step with set value = this.attr("step", value) |> ignore
        member this.pattern with set value = this.attr("pattern", value) |> ignore
        member this.readonly with set value = this.attr("readonly", value) |> ignore
        member this.disabled with set value = this.attr("disabled", value) |> ignore
        member this.multiple with set value = this.attr("multiple", value) |> ignore
        member this.accept with set value = this.attr("accept", value) |> ignore
        member this.list with set value = this.attr("list", value) |> ignore
        member this.maxlength with set value = this.attr("maxlength", value) |> ignore
        member this.minlength with set value = this.attr("minlength", value) |> ignore
        member this.size with set value = this.attr("size", value) |> ignore
        member this.src with set value = this.attr("src", value) |> ignore
        member this.height with set value = this.attr("height", value) |> ignore
        member this.width with set value = this.attr("width", value) |> ignore
        member this.alt with set value = this.attr("alt", value) |> ignore
    ...
    type textarea() =
        ...
        member this.readonly with set value = this.attr("readonly", value) |> ignore
        member this.disabled with set value = this.attr("disabled", value) |> ignore
        member this.rows with set value = this.attr("rows", value) |> ignore
        member this.cols with set value = this.attr("cols", value) |> ignore
        member this.wrap with set value = this.attr("wrap", value) |> ignore
        member this.maxlength with set value = this.attr("maxlength", value) |> ignore
    ...
    type option() =
        ...
        member this.value with set value = this.attr("value", value) |> ignore
        member this.selected with set value = this.attr("selected", value) |> ignore
        member this.disabled with set value = this.attr("disabled", value) |> ignore

    type label() =
        inherit HtmlElement("label")
        member this.for' with set value = this.attr("for", value) |> ignore
    ...
    type iframe() =
        ...
        member this.src with set value = this.attr("src", value) |> ignore
        member this.name with set value = this.attr("name", value) |> ignore
        member this.sandbox with set value = this.attr("sandbox", value) |> ignore
        member this.width with set value = this.attr("width", value) |> ignore
        member this.height with set value = this.attr("height", value) |> ignore
        member this.allowfullscreen with set value = this.attr("allowfullscreen", value) |> ignore
        member this.allowpaymentrequest with set value = this.attr("allowpaymentrequest", value) |> ignore
        member this.loading with set value = this.attr("loading", value) |> ignore
        member this.referrerpolicy with set value = this.attr("referrerpolicy", value) |> ignore
        member this.srcdoc with set value = this.attr("srcdoc", value) |> ignore

    type video() =
        inherit HtmlElement("video")
        member this.src with set value = this.attr("src", value) |> ignore
        member this.poster with set value = this.attr("poster", value) |> ignore
        member this.autoplay with set value = this.attr("autoplay", value) |> ignore
        member this.controls with set value = this.attr("controls", value) |> ignore
        member this.loop with set value = this.attr("loop", value) |> ignore
    ...
    type source() =
        ...
        member this.type' with set value = this.attr("type", value) |> ignore
        member this.media with set value = this.attr("media", value) |> ignore
        member this.sizes with set value = this.attr("sizes", value) |> ignore
        member this.srcset with set value = this.attr("srcset", value) |> ignore
    ...
    type object'() =
        ...
        member this.data with set value = this.attr("data", value) |> ignore
        member this.type' with set value = this.attr("type", value) |> ignore
        member this.width with set value = this.attr("width", value) |> ignore
        member this.height with set value = this.attr("height", value) |> ignore
