...
module Aria =
    ...
    type HtmlTag with
        ...
        member this.ariaAtomic with set (value: bool) = ()
        ...
        member this.ariaBusy with set (value: bool) = ()
        ...
        member this.ariaModal with set (bool: bool) = ()
        member this.ariaMultiLine with set (bool: bool) = ()
        member this.ariaMultiSelectable with set (bool: bool) = ()
        ...
        member this.ariaRequired with set (bool: bool) = ()
        ...
        member this.ariaSelected with set (bool: bool) = ()
